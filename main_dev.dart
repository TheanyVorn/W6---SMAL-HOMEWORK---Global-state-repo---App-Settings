...
import 'package:test/W6/data/app_settings_repo_mock.dart';
...
List<SingleChildWidget> get devProviders {
  return [
    ...
    ChangeNotifierProvider<AppSettingsState>(create: (_) => AppSettingsState(repository: AppSettingsRepositoryMock()),
    ),
  ];
}
